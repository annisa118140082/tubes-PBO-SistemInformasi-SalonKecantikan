...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Bulan Mei 2020 pada 14.55
...
--
-- Database: `salonkecantikan`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `bekerja`
--
...
--
-- Dumping data untuk tabel `bekerja`
--

INSERT INTO `bekerja` (`id_pegawai`, `pekerjaan_pegawai`, `tempat`) VALUES
('P1001', 'Bagian Pembayaran dan Jasa Menikur Pedikur', 'Lokasi'),
('P1002', 'Bagian Pembayaran', 'Lokasi'),
('P1003', 'Bagian Pembayaran dan Jasa Make Up', 'Lokasi'),
('P1004', 'Bagian Kebersihan Tempat Pelanggan, Merapikan Peralatan, dan Jasa Body and Spa', 'Lokasi'),
('L1001', 'Bagian Kebersihan Tempat Pegawai dan Jasa Perawatan Rambut', 'Lokasi'),
('L1002', 'Bagian Kebersihan Tempat Pegawai dan Jasa Meditasi', 'Lokasi'),
('L1003', 'Bagian Kebersihan Tempat Pelanggan dan Menjaga dan Mengontrol Keadaan Sekitar', 'Lokasi'),
('L1004', 'Bagian Kebersihan Tempat Pelanggan dan Mengontrol Peralatan dan Bahan di Salon', 'Lokasi');
...
--
-- Ketidakleluasaan untuk tabel `bekerja`
--
ALTER TABLE `bekerja`
  ADD CONSTRAINT `bekerja_ibfk_1` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id_pegawai`);
